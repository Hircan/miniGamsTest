...
test_font = pygame.font.Font(os.path.join(FONT_FOLDER,'Pixeltype.ttf'), 50)
start_time = 0
...
# Snail 
snail_frame_1 = pygame.image.load(os.path.join(GRAPHICS_FOLDER, 'snail/snail1.png')).convert_alpha()
snail_frame_2 = pygame.image.load(os.path.join(GRAPHICS_FOLDER, 'snail/snail2.png')).convert_alpha()
